...
.assistant-header { height: 68px; padding: 0 20px; flex: 0 0 68px; display: flex; align-items: center; gap: 12px; border-bottom: 1px solid rgb(var(--v-theme-outline)); background: #fff; }
...
.assistant-history { width: 248px; padding: 16px 12px 12px; flex: 0 0 248px; display: flex; flex-direction: column; border-right: 1px solid rgb(var(--v-theme-outline)); background: #eef3f5; }
...
.assistant-history-note { padding: 10px 4px 0; border-top: 1px solid rgb(var(--v-theme-outline)); color: #8999a0; font-size: 9px; text-align: center; }
