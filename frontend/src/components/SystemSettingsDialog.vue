  ...
  <v-dialog v-model="open" max-width="620">
    <v-card class="settings-card">
      ...
      <v-card-text class="settings-content">
        <div class="settings-section"><div class="section-label">主题与配色</div><v-select v-model="themePreference" :items="themeOptions" label="界面主题" /><div class="shortcut-settings__hint mt-2">默认使用浅色主题，可手动切换深色；选择后立即生效并自动保存。</div></div>
